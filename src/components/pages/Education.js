                ...
                <div className="flex justify-end">
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h4 className="text-xl font-extrabold text-white mb-1">Master of Science in Computer Science & Engineering</h4>
                        <p className="text-lg font-bold text-gray-100">The Ohio State University</p>
                        <p className="text-base text-gray-100">Columbus, OH</p>
                        <p className="text-base font-semibold text-white mt-1">Expected Graduation: May 2025</p>
                      </div>
                      <img 
                        src={osuLogo}
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h4 className="text-xl font-extrabold text-white mb-1">Bachelor of Technology in Mechanical Engineering</h4>
                        <p className="text-lg font-bold text-gray-100">Biju Patnaik University of Technology</p>
                        <p className="text-base text-gray-100">Rourkela, India</p>
                        <p className="text-base font-semibold text-white mt-1">Graduated: May 2021</p>
                      </div>
                      <img 
                        src={bputLogo}
                        alt="BPUT Logo" 
